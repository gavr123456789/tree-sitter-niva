...
enum ts_symbol_identifiers {
  ...
  sym__string_like = 65,
  sym__number_like = 66,
  sym__comment_like = 67,
  sym__identifier_like = 68,
  sym_explicit_type = 69,
  sym_keyword_send = 70,
  sym_annotation = 71,
  sym_operator = 72,
  sym_control_flow = 73,
